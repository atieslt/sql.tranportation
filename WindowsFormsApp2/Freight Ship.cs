...
{
    public partial class Freight_Ship : Form
    {
        SqlConnection sql10 = new SqlConnection("server=DESKTOP-CKGL1BN\\SQL2019 ;" +
        ...
        {
            sql10.Open();
            SqlDataAdapter data = new SqlDataAdapter("Freight_Ship", sql10);
